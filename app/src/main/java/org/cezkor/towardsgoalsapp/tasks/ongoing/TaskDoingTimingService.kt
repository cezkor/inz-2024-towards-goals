...
class TaskDoingTimingService : LifecycleService() {
    ...
    private var foregroundTxt: String = org.cezkor.towardsgoalsapp.Constants.EMPTY_STRING
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        val foregroundNotificationBuilder = Notification
            .Builder(this, org.cezkor.towardsgoalsapp.Constants.TASK_POMODORO_NOTIFICATION_CHANNEL)
