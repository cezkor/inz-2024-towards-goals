...
import org.cezkor.towardsgoalsapp.tasks.details.TaskInfoContract.Companion.TASK_ID_FROM_REQUESTER
import org.cezkor.towardsgoalsapp.tasks.details.TaskInfoContract.Companion.TASK_ID_IF_REFRESH_FOR_REQUESTER
import org.cezkor.towardsgoalsapp.tasks.details.TaskInfoContract.Companion.TASK_OWNER_ID_FROM_REQUESTER
...
class TaskInfoContract: ActivityResultContract<TupleOfFour<Long, Long, Long, Boolean>, Long>() {
    ...
    override fun parseResult(resultCode: Int, intent: Intent?): Long {
        val data = intent?.getLongExtra(TASK_ID_IF_REFRESH_FOR_REQUESTER, org.cezkor.towardsgoalsapp.Constants.IGNORE_ID_AS_LONG)
...
class TaskDetails : AppCompatActivity() {
    ...
    private var taskId = org.cezkor.towardsgoalsapp.Constants.IGNORE_ID_AS_LONG
    private var goalId = org.cezkor.towardsgoalsapp.Constants.IGNORE_ID_AS_LONG
    private var taskOwnerId = org.cezkor.towardsgoalsapp.Constants.IGNORE_ID_AS_LONG
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        return when (item.itemId) {
            ...
            R.id.deleteTaskItem -> {
                if ( forAdding )  {
                    taskId = org.cezkor.towardsgoalsapp.Constants.IGNORE_ID_AS_LONG
    ...
    override fun onRestoreInstanceState(
        ...
        savedInstanceState?.run {
            ...
            taskId = getLong(TASK_ID, org.cezkor.towardsgoalsapp.Constants.IGNORE_ID_AS_LONG)
            goalId = getLong(GOAL_ID, org.cezkor.towardsgoalsapp.Constants.IGNORE_ID_AS_LONG)
            taskOwnerId = getLong(TASK_OWNER_ID, org.cezkor.towardsgoalsapp.Constants.IGNORE_ID_AS_LONG)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fun prepareUI() {
            ...
            viewModel.mutableTaskData.observe(this) {
                ...
                canAddTask = ( it.taskDepth + 1 < org.cezkor.towardsgoalsapp.Constants.MAX_TASK_DEPTH ) && ! taskDone
    ...
    private fun determineResultOnPlannedFinish() {
        val result = if (taskId == org.cezkor.towardsgoalsapp.Constants.IGNORE_ID_AS_LONG) RESULT_CANCELED else RESULT_OK
