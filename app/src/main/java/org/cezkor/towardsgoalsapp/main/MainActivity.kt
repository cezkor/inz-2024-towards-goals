...
import org.cezkor.towardsgoalsapp.goals.AddGoalSuggestion
import org.cezkor.towardsgoalsapp.goals.GoalSynopsis
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fun prepareActivity() {
            ...
            var pageNum = 0
            while (pageNum < org.cezkor.towardsgoalsapp.Constants.MAX_GOALS_AMOUNT){
            ...
            savedInstanceState?.run {
                ...
                if ( (i > 0) and (i < org.cezkor.towardsgoalsapp.Constants.MAX_GOALS_AMOUNT) ) { goalPager.currentItem = i }
            }
        }
    ...
    private inner class GoalPagesAdapter(
        ...
        override fun getItemCount(): Int = org.cezkor.towardsgoalsapp.Constants.MAX_GOALS_AMOUNT
