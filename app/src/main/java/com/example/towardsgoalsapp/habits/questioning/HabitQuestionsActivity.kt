...
import com.example.towardsgoalsapp.Constants.Companion.viewModelClassToNumber
...
import com.example.towardsgoalsapp.habits.questioning.HabitQuestioningContract.Companion.HABIT_MARKING_BY_NOTIFICATION
...
import com.example.towardsgoalsapp.stats.questions.QuestionItemListViewModel
...
class HabitQuestionsViewModel(private val dbo: TGDatabase,
    ...
    HabitViewModel(dbo, habitId, Constants.IGNORE_ID_AS_LONG), ViewModelWithDoubleValueQuestionList {
...
class HabitQuestions : AppCompatActivity() {
    ...
    override fun onDestroy() {
        if (isFinishing) {
            val goalId = viewModel.mutableHabitData.value?.goalId ?: Constants.IGNORE_ID_AS_LONG
