...
class ImpIntRepositoryTests {
    ...
    fun `basic database interaction`() {
        runBlocking {
            ...
            var iiList =  repo.getAllByOwnerTypeAndId(OwnerType.TYPE_TASK, 100)
            ...
            assertThat(iiList[0].ownerType).isEqualTo(OwnerType.TYPE_TASK)
            ...
            iiList = repo.getAllByOwnerTypeAndId(OwnerType.TYPE_HABIT, 100)
            assertThat(iiList.size).isEqualTo(1)
            ...
            assertThat(iiList[0].ownerId).isEqualTo(100)
            assertThat(iiList[0].ownerType).isEqualTo(OwnerType.TYPE_HABIT)
            ...
            iiList = (repo.getAllByOwnerTypeAndId(OwnerType.TYPE_TASK, 100) +
                    repo.getAllByOwnerTypeAndId(OwnerType.TYPE_HABIT, 100))
            ...
            iiList = repo.getAllByOwnerTypeAndId(OwnerType.TYPE_HABIT, 100)
            assertThat(iiList.size).isEqualTo(0)
            iiList = repo.getAllByOwnerTypeAndId(OwnerType.TYPE_NONE, 100)
            assertThat(iiList.size).isEqualTo(0)
        }
    ...
    fun `unfinished data handled properly`() { runBlocking {
        ...
        var iiList: ArrayList<ImpIntData>
            = repo.getAllByOwnerTypeAndId(OwnerType.TYPE_TASK, 100)
        assertThat(iiList.size).isEqualTo(0)
